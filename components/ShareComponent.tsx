...
export default function ShareComponent({ riskResult, qrSvg }: Props) {
    ...
    <div className="mt-4 p-5 sm:p-6 card-elevated">
      ...
      <div className="flex flex-col sm:flex-row gap-5">
        ...
        <div className="flex-1 grid grid-cols-2 gap-2">
          ...
          <a href={`https://wa.me/?text=${WHATSAPP_MSG}`} target="_blank" rel="noopener noreferrer" className={btnClass} aria-label="Share on WhatsApp">
