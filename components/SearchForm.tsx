...
export default function SearchForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-3" noValidate>
      ...
      {/* Submit button — immediately after input so it stays visible when mobile keyboard opens */}
      <button
        type="submit"
        disabled={!canSubmit}
      ...
      {/* Secondary helpers — below button so they don't push it off screen on mobile */}
