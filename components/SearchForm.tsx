        ...
        {tipOpen && (
          <div className="mb-3 p-3.5 bg-blue-50 border border-blue-100 rounded-lg text-sm text-gray-700 space-y-2">
            ...
            <div className="pt-1.5 border-t border-blue-100">
              <p className="text-xs text-gray-600"><span className="font-medium">Numbered companies:</span> Some employers file under a numbered name like <span className="font-mono bg-white px-1 rounded border border-gray-200">1234567 BC Ltd.</span> or <span className="font-mono bg-white px-1 rounded border border-gray-200">9363-2891 Québec Inc.</span> — this may differ from the trade name on your offer letter. Try both.</p>
            </div>
          </div>
        )}
        <input
