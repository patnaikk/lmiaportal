...
export default function HomeSignupWidget() {
  ...
  return (
    <div>
      <p className="text-xs text-gray-500 mb-2">Get the monthly report in your inbox — free.</p>
      <form onSubmit={handleSubmit} className="flex gap-2">
        <input
          ...
          className="flex-1 min-w-0 text-sm px-3 py-2 rounded-xl border border-gray-200 bg-gray-50 placeholder-gray-400 text-gray-900 focus:outline-none focus:ring-2 focus:ring-red-300 disabled:opacity-50"
        />
        <button
          type="submit"
          disabled={state === 'loading' || !email.trim()}
          className="px-4 py-2 rounded-xl bg-gray-900 text-white text-sm font-semibold hover:bg-gray-700 transition-colors disabled:opacity-50 whitespace-nowrap"
        >
